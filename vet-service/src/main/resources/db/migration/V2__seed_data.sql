-- V2: Seed data matching the PetClinic sample dataset for the Vet domain

-- Insert specialties with explicit IDs
...
-- Reset auto-increment to avoid conflicts with future inserts
ALTER TABLE specialties ALTER COLUMN id RESTART WITH 100;

-- Insert vets with explicit IDs
