...
-- Creates tables for specialties, vets, and the many-to-many join table
...
-- Seed data for development: common vet specialties
...
-- Seed data for development: sample vets
...
-- Reset auto-increment counters past the seed data IDs
