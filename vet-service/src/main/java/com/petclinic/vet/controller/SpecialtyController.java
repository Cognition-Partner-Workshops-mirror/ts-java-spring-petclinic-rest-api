 ...
 * Endpoints match the OpenAPI /specialties paths.
 */
@RestController
...
public class SpecialtyController {
    ...
    /** GET /api/specialties — list all specialties or search by name */
    @GetMapping
    ...
    /** GET /api/specialties/{specialtyId} — get a single specialty by ID */
    @GetMapping("/{specialtyId}")
    public ResponseEntity<SpecialtyResponseDto> getSpecialty(
            @PathVariable Integer specialtyId) {
        SpecialtyResponseDto dto = specialtyService.getSpecialtyById(specialtyId);
