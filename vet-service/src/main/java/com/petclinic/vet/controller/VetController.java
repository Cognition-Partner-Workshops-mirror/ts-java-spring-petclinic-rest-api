...
public class VetController {
    ...
    public ResponseEntity<List<VetResponseDto>> listVets(
        ...
        List<VetResponseDto> results;
        if (lastName != null && specialty != null) {
            results = vetService.findByLastNameAndSpecialtyName(lastName, specialty);
        } else if (lastName != null) {
            results = vetService.findByLastName(lastName);
        } else if (specialty != null) {
            results = vetService.findBySpecialtyName(specialty);
        } else {
            results = vetService.findAll();
        }
