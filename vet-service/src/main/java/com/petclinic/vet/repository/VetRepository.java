...
public interface VetRepository extends JpaRepository<Vet, Integer> {
    ...
    @Query("SELECT v FROM Vet v WHERE LOWER(v.firstName) LIKE LOWER(CONCAT('%', :firstName, '%'))")
    List<Vet> findByFirstNameContainingIgnoreCase(@Param("firstName") String firstName);
}
