...
/**
 * Request DTO mapping to the VetFields OpenAPI schema.
 * Used for creating and updating vets.
 */
public class VetRequestDto {
    ...
    public VetRequestDto(String firstName, String lastName, List<SpecialtyDto> specialties) {
