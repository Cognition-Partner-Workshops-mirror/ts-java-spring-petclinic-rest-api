...
/**
 * Unit tests for JPA entity classes to cover getters, setters, and lifecycle callbacks.
 */
class EntityTest {
    ...
    @Test
    void specialty_onUpdateSetsUpdatedAt() {
        Specialty specialty = new Specialty();
        specialty.onCreate();
    ...
    @Test
    void vet_onUpdateSetsUpdatedAt() {
        Vet vet = new Vet();
        vet.onCreate();
    ...
    @Test
    void vet_defaultSpecialtiesIsEmpty() {
        Vet vet = new Vet();
