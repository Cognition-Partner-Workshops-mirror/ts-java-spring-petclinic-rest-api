...
class VetRestControllerTest {
    ...
    void listVets_returnsAllVets() throws Exception {
        VetResponseDto vet1 = new VetResponseDto(1, "James", "Carter", Collections.emptyList());
        VetResponseDto vet2 = new VetResponseDto(2, "Helen", "Leary",
    ...
    void listVets_filterByLastName() throws Exception {
        VetResponseDto vet = new VetResponseDto(1, "James", "Carter", Collections.emptyList());
    ...
    void addVet_invalidRequest_returns400() throws Exception {
        VetRequestDto request = new VetRequestDto("", "", Collections.emptyList());
        ...
        mockMvc.perform(post("/api/vets")
            ...
            .andExpect(jsonPath("$.schemaValidationErrors").exists());
    }
    ...
    void updateVet_validRequest_returns200() throws Exception {
        ...
        VetResponseDto response = new VetResponseDto(1, "Updated", "Carter", Collections.emptyList());
    ...
    void addVet_withSpecialties_returns201() throws Exception {
        ...
        VetResponseDto response = new VetResponseDto(2, "Helen", "Leary", List.of(specDto));
        when(vetService.create(any(VetRequestDto.class))).thenReturn(response);
